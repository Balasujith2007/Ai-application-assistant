import { CanonicalFieldKey, FIELD_ALIASES } from '../mappings/aliases';
import { classifyField, FieldClassification, normalizeLabel } from './question-classifier';
...
export function matchField(
  signals: { label?: string; name?: string; id?: string; placeholder?: string; autocomplete?: string; type?: string },
