...
export async function buildExtensionProfile(userId: string): Promise<ExtensionProfileSnapshot | null> {
  ...
  const snapshot: ExtensionProfileSnapshot = {
    ...
    personal: {
      ...
      gender: meta(profile?.gender, 'existing-profile', { label: 'Gender', category: 'personal' }),
      disabilityStatus: meta(profile?.disabilityStatus, 'existing-profile', { label: 'Disability Status', category: 'personal' }),
      disability: meta(profile?.disabilityStatus, 'existing-profile', { label: 'Disability Status', category: 'personal' }),
