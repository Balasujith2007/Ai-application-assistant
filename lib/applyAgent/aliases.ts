/**
 * Deterministic field aliases.
 * Exact / substring matching happens BEFORE any AI fallback.
 */
...
export const FIELD_ALIASES: Record<CanonicalFieldKey, string[]> = {
  'personal.firstName': [
    'first name', 'given name', 'forename', 'candidate first name', 'firstname', 'fname',
  ],
  'personal.lastName': [
    'last name', 'surname', 'family name', 'candidate last name', 'lastname', 'lname',
  ],
  'personal.fullName': [
    'full name', 'candidate name', 'applicant name', 'student name', 'participant name',
    'your name', 'name of applicant',
  ],
  'personal.email': [
    'email', 'email address', 'e mail', 'e-mail', 'candidate email', 'student email',
    'work email', 'contact email',
  ],
  'personal.phone': [
    'phone', 'phone number', 'mobile', 'mobile number', 'contact number', 'whatsapp',
    'phone no', 'cell', 'telephone',
  ],
  'personal.dateOfBirth': [
  ...
  'education.college': [
    'college', 'college name', 'institution', 'institution name', 'university',
    'university name', 'institute', 'school name',
  ],
  'education.degree': [
    'degree', 'qualification', 'highest qualification', 'program',
  ],
  'education.department': [
  ...
  'education.year': [
    'academic year', 'current year', 'year of study', 'year',
  ],
  ...
  'documents.resume': [
    'resume', 'cv', 'upload resume', 'attach resume', 'upload cv', 'resume file',
  ],
  'documents.coverLetter': [
...
export const SENSITIVE_PATTERNS = [
  ...
  'criminal', 'conviction', 'hispanic', 'lgbt', 'pronoun', 'religion', 'caste',
];

export const LEGAL_PATTERNS = [
  'terms', 'conditions', 'privacy policy', 'i agree', 'declaration', 'certify',
  'signature', 'acknowledge', 'consent to', 'indemnify',
];
...
export const APPLICATION_SPECIFIC_PATTERNS = [
  ...
  'leadership experience', 'greatest weakness', 'cover letter text',
  'why join', 'motivation to join',
];

export const DOCUMENT_PATTERNS = [
  'resume', 'cv', 'cover letter', 'certificate', 'portfolio file', 'transcript',
];
