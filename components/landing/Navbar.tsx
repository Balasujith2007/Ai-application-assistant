...
export default function Navbar() {
  ...
  // Auto-open modal if URL has ?login=true or error params
  useEffect(() => {
    if (searchParams?.get('login') === 'true' || searchParams?.get('error')) {
  ...
  return (
    <>
        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden items-center gap-3 md:flex">
            <button
              ...
              className="rounded-lg px-4 py-2 text-sm font-semibold text-slate-700 hover:text-slate-900 hover:bg-slate-100/80 transition-colors cursor-pointer"
            >
              Login
            </button>
            <Link
          ...
          <div className="border-b border-slate-200 bg-white px-4 pt-3 pb-6 md:hidden shadow-lg animate-in fade-in">
            ...
            <div className="mt-5 flex flex-col gap-2.5 border-t border-slate-100 pt-4">
              <button
                ...
                className="w-full text-center rounded-lg border border-slate-200 px-4 py-2.5 text-sm font-semibold text-slate-800 hover:bg-slate-50 cursor-pointer"
              >
                Login
              </button>
              <Link
      ...
      {/* In-Place Home Page Login Modal */}
      <LoginModal
